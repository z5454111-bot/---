import{d as _,l as y,c as m,a as e,t as r,F as b,r as $,g as k,f as x,w,v as T,p as H,q as M,e as C,b as i,h as I,s as V,o as v,n as B}from"./index-BnfEGlQv.js";import{u as R}from"./player-D6p8R_Yg.js";import{s as S,a as K}from"./tavern-r20hoDvh.js";import{_ as N}from"./plugin-vue_export-helper-DlAUqK2U.js";const P={class:"home-container"},j={class:"chat-main"},A={class:"message system-message"},D={class:"message-content yaml-content"},F={class:"message-avatar"},q={class:"message-content"},z={key:0,class:"message ai-message"},E={class:"message-content streaming-content"},G={class:"chat-input-area"},L=["onKeydown","disabled"],U=["disabled"],Y={class:"sidebar right-sidebar"},J={class:"sidebar-content"},O={class:"placeholder-text"},Q=_({__name:"Home",setup(W){const s=R(),c=i(null),d=i([]),l=i(""),n=i(!1),u=i(""),g=I(()=>`---
角色信息:
  姓名: ${s.name}
